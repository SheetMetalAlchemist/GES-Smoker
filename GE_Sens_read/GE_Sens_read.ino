...
void readSens() {
    ...
    for (int Channel=1;Channel<3;Channel++)
     ...
     Serial.print(SensorReading[Channel]);  // GET A SINGLE SENSOR READING BY LOOKING AT SensorReading[Channel#] here spits out a strange format - leading whitespace plus a duplicate of the number we are trying to find
